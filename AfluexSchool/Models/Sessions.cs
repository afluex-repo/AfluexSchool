...
namespace AfluexSchool
{
    public static class Sessions
    {
        ...
        public static string PK_UserID
        {
            get
            {
                ...
                if (HttpContext.Current.Session["AdminID"] != null)
                    PKID = HttpContext.Current.Session["AdminID"].ToString().ToLower();
                ...
                else
                {
                    switch (UserType)
                    {
                        ...
                        case "crm-admin-searched":
                            RetMasterPage = "~/Admin/BeyondMLMSearchMaster.master";
                            break;
                        ...
                        case "operation-searched":
                            ...
                            break;
                        case "super":
                            RetMasterPage = "~/Admin/BeyondMLMAdminMaster.Master";
                            break;
                        case "adminmlm":
                            RetMasterPage = "~/HomeMasterPage.Master";
                            break;
                        case "level-admin":
                            RetMasterPage = "~/levelAdmin/BeyondMLMAdminMaster.Master";
                            break;
                        case "crm-admin":
                        ...
                        case "manager":
                            ...
                            break;
                        case "agent":
                            RetMasterPage = "~/Agent/BeyondUserMaster.Master";
                            break;
                ...
                else
                {
                    switch (UserType)
                    {
                        ...
                        case "super":
                            ...
                            break;
                        case "admin":
                            RetWelcomePage = "~/Admin/AdminMLMMasterPage.Master";
                            break;
                        case "crm-admin":
        ...
        public static string NoPermissionPage
        {
            get
            {
                return "~/FormAccessPermission.aspx";
            }
