            ...
            datasets: [
                {
                    ...
                    borderWidth: "0",
                    backgroundColor: 'rgba(102, 115, 253, 1)'
                }
            ]
        },
        options: {
...
//gradient bar chart
    ...
    barChart_2gradientStroke.addColorStop(0, "rgba(102, 115, 253, 1)");
    barChart_2gradientStroke.addColorStop(1, "rgba(102, 115, 253, 0.5)");
...
if(jQuery('#barChart_3').length > 0 ){
    ...
    barChart_3gradientStroke.addColorStop(0, "rgba(102, 115, 253, 1)");
    barChart_3gradientStroke.addColorStop(1, "rgba(102, 115, 253, 0.5)");
...
if(jQuery('#lineChart_3').length > 0 ){
    ...
    lineChart_3gradientStroke1.addColorStop(0, "rgba(102, 115, 253, 1)");
    lineChart_3gradientStroke1.addColorStop(1, "rgba(102, 115, 253, 0.5)");
            ...
            datasets: [
                {
                    ...
                    borderWidth: "1",
                    backgroundColor: 'rgba(102, 115, 253, .5)', 
